  ...
  return (
    <Drawer.Root>
      <Drawer.Trigger asChild>
        <button className="flex">Scrollable</button>
      </Drawer.Trigger>
      <Drawer.Portal>
        <Drawer.Overlay className="fixed inset-0 bg-black/40" />
        <Drawer.Content className="max-w-md mx-auto bg-white flex flex-col fixed bottom-0 left-0 right-0 max-h-[96%] rounded-t-[10px]">
          <div className="mt-4">
            <DragButton />
          </div>

          <div className="max-w-md w-full mx-auto flex flex-col overflow-auto scroll_drawer p-4 rounded-t-[10px]">
            <input
